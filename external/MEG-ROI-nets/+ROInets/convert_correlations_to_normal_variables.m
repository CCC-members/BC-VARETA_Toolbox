...
[~, corrMats.envCorrelation_z]                 = ROInets.Fisher_r_to_z(corrMats.envCorrelation,   ...
                                                            corrMats.nSamples,         ...
                                                            nullHypothesisCorrelation, ...
                                                            sigma.z);
[~, corrMats.envPartialCorrelation_z]         = ROInets.Fisher_r_to_z(corrMats.envPartialCorrelation, ...
                                                            corrMats.nSamples,              ...
                                                            nullHypothesisCorrelation,      ...
                                                            sigma.z_partial);
...
if doRegularize && isfield(corrMats, 'envPartialCorrelationRegularized'),
     ...
     % zero. 
    [~, corrMats.envPartialCorrelationRegularized_z] = ROInets.Fisher_r_to_z(corrMats.envPartialCorrelationRegularized, ...
                                                            corrMats.nSamples,                         ...
                                                            nullHypothesisCorrelation,                 ...
                                                            sigma.z_partial);
end%if
