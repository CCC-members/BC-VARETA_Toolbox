function [s2j,sigma2j_post,Tjv,Svv,LvjW,scaleJ,scaleLvj] = sSSBLpp(Svv,Lvj,param)
...
clearvars sigma2jW LvjWsigma2jW;
% Iterative Transference Operator
Tjv                        = (1/sigma2x).*(W*sigma2jWLjv-sigma2j_post0*(LvjWsigma2j*WLjv));
clearvars sigma2x W sigma2jWLjv sigma2j_post0 LvjWsigma2j WLjv;
if(~run_bash_mode)
    text = replace(param.str_band,'_','-');
