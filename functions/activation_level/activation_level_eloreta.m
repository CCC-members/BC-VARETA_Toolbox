...
%%
if IsCurv == 0    
    [s2j,sigma2j_post,T,~,~,scaleSvv,scaleLvj] = eloreta(Svv,Lvj,param);
    clearvars param Svv;
...
elseif IsCurv == 1
    ...
    [s2j_giri,sigma2j_post_giri,Tgiri,~,~,scaleSvv_giri,scaleLvj_giri] = eloreta(Svv,subject.Lvj_giri,param);
    param.flag = strcat(flag," Sulci compensation");
    [s2j_sulc,sigma2j_post_sulc,Tsulc,~,~,scaleSvv_sulc,scaleLvj_sulc] = eloreta(Svv,subject.Lvj_sulc,param);
    clearvars param Svv;
